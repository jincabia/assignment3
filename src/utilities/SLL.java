/**
 * Created on Oct 26, 2023 Project: demo07 - SLL
 */
 ...
 *
 * @author kitty
 * @version 1.2 Class Description: Implementation of the List interface as a
 *          Singly Linked List (SLL). Positions are zero-based (e.g. index 0 =
 *          first position = first element/node.
 */
